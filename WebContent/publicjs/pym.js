var strChineseFirstPY="YDYQSXMWZSSXJBYMGCCZQPSSQBYCDSCDQLDYLYBSSJGYZZJJFKCCLZDHWDWZJLJPFYYNWJJTMYHZWZHFLZPPQHGSCYYYNJQYXXGJ"
...
var oMultiDiff={"19969":"DZ","19975":"WM","19988":"QJ","20048":"YL","20056":"SC","20060":"NM","20094":"QG","20127":"QJ",
				...
				"20911":"PF","20985":"AW","21032":"PB","21048":"XQ","21049":"SC","21089":"YS","21119":"CJ","21242":"SB",
				...
				"36158":"JG","36228":"QJ","36426":"XQ","36466":"DC","36710":"CJ","36711":"ZYG","36767":"PB","36866":"SK",
				...
				"40516":"HG","40536":"HG","40583":"QJ","40765":"YQ","40784":"QJ","40840":"YK","40863":"QJG"};//参数,中文字符串
 ...
 * pymcs为拼音码选择框id
 */
function selectInitPym(str){
	var result = makePy(str);
	$("#pymcs").empty();
	$("#pym").val("");
	$("#pym").val(result[0]);
	for(var i=0;i<result.length;i++){		
		$("#pymcs").append("<option value="+result[i]+">"+result[i]+"</option>");
	};
}
		...
		if(strlen == 1){
			...
			//复制一个相同的arrRslt
				...
				for(var j=0;j<tmp.length;j++){
					tmp[j] += str.charAt(k).toLowerCase();
				}
