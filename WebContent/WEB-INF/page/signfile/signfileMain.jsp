...
//新增
function doAdd(){
	var fType='${xx:encode(page.pd.fType,"utf-8")}'; //解决IE6 编码 不能转UTF-8 问题
	var url="mSignFileUI.do?fId=0&fType="+fType;
	location.href=url;
}
...
function doEdit(){
	...
	var fType='${xx:encode(page.pd.fType,"utf-8")}'; //解决IE6 编码 不能转UTF-8 问题
	var url="mSignFileUI.do?fId="+fId+"&fType="+fType;
	location.href=url;
}
		...
		<div class="develop">
			...
			<c:forEach items="${file.fAttachmentUrl.split(',') }" var="url" varStatus="vs">
		       ...
		       ;
				...
				<!-- 底部分页 -->
		  <form action="mSignFileMain.do"   id="formQuery" method="post">
