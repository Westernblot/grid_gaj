...
<div id="div_right">
	<div class="right_top">
		...
		<form action=""  id="form1">
		   ...
		   <td  >
		   <input type="hidden" size="80" id="fReceivedId" name="fReceivedId" value="" want="yes" title="收件人" readOnly >
		  
		   <input type="text" size="80" id="fReceived" name="fReceived" value="" readOnly>
	  ...
	  <span id="pageNo"></span>/<span id="totalPage"></span>页,共 <span id="totalRecord"></span>条,每页 20 条	    
		   ...
		   <td >主题</td>
		   <td >
		   <input type="text" size="100" id="fSubject" name="fSubject" value="转发：${pData.F_SUBJECT }" >
		   </td>
		   </tr>
