...
function doAdd(){
	...
	var url="mRedNewsUI.do?fId=0&fGroup="+fGroup;
	location.href=url;
}
...
function doEdit(){
	...
	var fGroup='${page.pd.fGroup}';
	var url="mRedNewsUI.do?fId="+fId+"&fGroup="+fGroup;
	location.href=url;
}
...
<div id="div_right">
	<div class="right_top">
				...
				<div class="title">
					...
					<form action="mRedNewsMain.do" style="display:none"  id="formQuery" method="post">
					       <!-- 文章分类 -->
