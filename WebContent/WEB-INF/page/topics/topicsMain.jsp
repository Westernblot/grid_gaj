...
function doAdd(){
	...
	var fType='${page.pd.fType}';
	var url="mTopicsUI.do?fId=0&fType="+fType;
	location.href=url;
}
...
function doEdit(){
	...
	var fType='${page.pd.fType}';
	var url="mTopicsUI.do?fId="+fId+"&fType="+fType;
	location.href=url;
}
...
<div id="div_right">
	<div class="right_top">
				...
				<div class="title">
					...
					<form action="mTopicsMain.do" style="display:none"  id="formQuery" method="post">
