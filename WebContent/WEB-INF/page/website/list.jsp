...
<div id="container">
  ...
  <div id="content">
      <div class="navbottom"><em></em>您当前的位置：<a href="home">首页</a> > <a href="list?fGroup=${xx:encode(fGroup,'utf-8')}">${fGroup}</a> </div>
  	<div class="nyside">
  	<%--
        <div class="Rside">
          <div class="Rside_title"><h4>部门工作动态</h4></div>
          <ul class="Rside_con"> 
            <li><a href="list?fGroup=办公室动态">办公室动态</a></li>
            <li><a href="list?fGroup=治安管理动态">治安管理动态</a></li>
            <li><a href="list?fGroup=社区警务管理动态">社区警务管理动态</a></li>
            <li><a href="list?fGroup=治安行动动态">治安行动动态</a></li>
          </ul>
        </div>
  	 --%>
          <div class="nyside_02">
    ...
    <div class="nymain">
        ...
        <div class="nymain_con">
           <div class="list sjlist">
                ...
                <li><a href="${news.fLink!=''?news.fLink:'show'}?fId=${news.fId}&fRed=${xx:encode(news.fRed,'utf-8')}" target="_blank">${fn:length(news.fSubject)<20?(news.fSubject):(news.fSubject.substring(0,20))}</a><span>[${news.fDate.substring(5,10)}]</span></li>
                 </c:forEach>
                <%--
