  ...
  <div id="content">
      <div class="navbottom"><em></em>您当前的位置：<a href="home">首页</a> > <a href="list?fGroup=${xx:encode(news.fGroup,'utf-8')}">${news.fGroup }</a> > 正文 </div>
  	 <div class="showDoc02">  
               ...
               <div class="showDoc_title">黄 石 市 公 安 局</div>
               <div class="showDoc_line"></div>
              <div class="showDoc_flag">
                	<div class="right">${news.fSource }</div>
                </div>
              <h1 style="text-align:center; line-height:42px; margin:48px 0; font-size:30px;">
              ${news.fSubject}
              </h1>
